...
import 'package:login_edit/database/user_database.dart';
import 'package:login_edit/model/user_model.dart';
import 'package:login_edit/model/userlogin_model.dart';
import 'package:login_edit/ui/pages/profile_screen.dart';
...
class UserController {
  ...
  void login(context, String nome, String password){
    ...
    var result2 = users.where((user) => user.password == password);
